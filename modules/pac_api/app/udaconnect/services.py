...
class PersonService:
    ...
    def create(person: Dict) -> Person:
        ...
        # Kafka workflow
        try:
            kafka_producer.send(KAFKA_TOPIC, json.dumps(person).encode())
            kafka_producer.flush()
            logger.info('PersonService.create(): Kafka flush() seccessful.')
        except KafkaTimeoutError:
            logger.warning('PersonService.create(): Kafka flus() failed.')
...
logger = logging.getLogger("udaconnect-pac-api")
